			...
			<div id="contentsWrap" class="contentsWrap">
				<div class="contents">
					...
					<div class="tbWrapRt" style="padding-right: 220px; margin-top: 80px;  ">
						...
						<form action="/orm/memberUpdate.do" name="joinFrm" method="post" >
						...
						<table style="margin-left: 500px;">
								...
								<tbody>
								<tr>
									<th style=" width:100px; height:25px;">새 이름</th>
						 ...
						 <span class="buttonFuc"><a href="javascript:sendPost()">우편번호</a></span><br>
								...
								<tr>
									...
									<span > <a class=""  href="#" name="send" id="send" >수정</a></span>
									</td>
								</tr>
								</table>
					</form>
