 ...
 <!-- Stylesheets -->
  ...
  <body>
	...
	<!----------------- 추가내용 ------------------->
	  	   ...
	  	   <table style="margin-left: 500px; margin-top: 50px; margin-bottom: 30px;">
     <tr>
      <td>&nbsp;</td>
      <td align="center">제목</td>
      <td><input name="qtitle" id="qtitle" size="50" maxlength="100"></td>
      <td>&nbsp;</td>
     </tr>
     ...
     <tr>
      ...
      <td><textarea name="qcontents" id="qcontents" cols="50" rows="13"></textarea></td>
      <td>&nbsp;</td>
     </tr>
     ...
     <tr align="center">
      <td>&nbsp;</td>
     <td colspan="2">
      <a class="button button-sm button-secondary button-nina" href="/orm/rewiewWrite.do">등록</a>
      <a class="button button-sm button-secondary button-nina" href="review.jsp">취소</a>
      <td>&nbsp;</td>
     </tr>
    </table>
